...
const AddDigitalProductPage = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      if (res.status === 200) {
        message.success("Digital product added successfully!");
        navigate("/products");
      }
      setLoading(false);
    } catch (error) {
    ...
    <div className="flex">
      ...
      <div className="main-content" style={{ marginLeft: "250px", width: "calc(100% - 250px)" }}>
        <div className="top-bar bg-white border-b p-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold">Add Digital Product</h1>
        ...
        <div className="p-6">
          <div className="bg-white p-6 rounded shadow max-w-2xl">
            <h2 className="text-xl font-semibold mb-6">Digital Product Information</h2>
            <Form layout="vertical" onFinish={onFinish}>
              ...
              >
                <Input placeholder="Enter digital product name" />
              </Form.Item>
...
export default AddDigitalProductPage;
